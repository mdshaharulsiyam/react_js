...
const BestSelingProductCart = ({ products }) => {
    const { id, name, price, rating, image_url, description } = products
    return (
        <div className='md:w-[32.5%] w-full box-border p-3'>
...
export default BestSelingProductCart
